...
# Load Model
llm = LlamaCpp(model="./models/llama-2-7b-chat.ggmlv3.q2_K.bin", n_gpu_layers=n_gpu_layers, n_batch=n_batch, n_ctx=2048, f16_kv=True, callback_manager=callback_manager, verbose=False)
